...
class ListSelector():
    ...
    parameterList = { "Linac3 ITF.DHZ02":
                    {"name": "ITF.DHZ02/REF.PULSE.REF#VALUE",
                      "type": "scalarNonLSA", 'startDirection': 0.5, "minimalAcceptedChange": 0.01, 'bounds':[0 ,0]},
                      "Linac3 ITF.DHZ03":
                    ...
                    {"name": "IA2.RF/SettiPPMProperty#ref_amplit",
                      "type": "scalarNonLSA", 'startDirection': 1e-3, "minimalAcceptedChange": 0.01, 'bounds':[0 ,0]},
                      "Linac3 Tank2 phase":
                    ...
                    "EI.BVN10/K":
                     {"name": "rmi://virtual_sps/logical.EI.BVN10/K",
                      "type": "scalar", 'startDirection': 5e-4, "minimalAcceptedChange": 0.01, 'bounds':[0 ,0]},
                     "EI.BVN20/K":
                         {"name": "rmi://virtual_sps/logical.EI.BVN20/K",
                          "type": "scalar", 'startDirection': 5e-4, "minimalAcceptedChange": 0.01, 'bounds':[0 ,0]},
                     "EI.BHN10/K":
                         {"name": "rmi://virtual_sps/logical.EI.BHN10/K",
                          "type": "scalar", 'startDirection': 1e-3, "minimalAcceptedChange": 0.01, 'bounds':[0 ,0]},
                     "ETL.BHN20-INJ/K":
                         {"name": "rmi://virtual_sps/logical.ETL.BHN20-INJ/K",
                          "type": "scalar", 'startDirection': 1e-3, "minimalAcceptedChange": 0.01, 'bounds':[0 ,0]},
                         "ITH.DHZ10/K":
                             {"name": "rmi://virtual_sps/logical.ITH.DHZ10/K",
                              "type": "scalar", 'startDirection': 1e-4, "minimalAcceptedChange": 0.01, 'bounds':[0 ,0]},
                         "ITH.DHZ11/K":
...
#                          "type": "scalar"},
                         "ETL.GSBHN10/KICK":
                             ...
                             "type": "function", "time": [110, 660], 'startDirection': 1e-3, "minimalAcceptedChange": 0.01, 'bounds':[0 ,0]},
                          "LEIRBEAM/injectionBump_CTRS10_H_1mm":
                             {"name": "rmi://virtual_leir/LEIRBEAM/injectionBump_CTRS10_H_1mm",
                              ...
                              'startDirection': 1e-3, "minimalAcceptedChange": 0.01, 'bounds':[0 ,0]},
...
#                             "type": "function", "time": [0, 60]}
    ...
    def setBoundaries(self, key, value):
       print(value)
       if len(key)>0:
        self.parameterList[key]["bounds"] = [-value, value]
